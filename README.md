...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/requests-aws4auth-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8685&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/requests-aws4auth-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `requests-aws4auth` can be installed with:

```
conda install requests-aws4auth
```

It is possible to list all of the versions of `requests-aws4auth` available on your platform with:
